	...
	if (isset($_POST[$position])) {
		if ($row['max_vote'] > 1) {
				...
				foreach ($_POST[$position] as $key => $values) {
					...
					$output .= "
							<div class='row votelist'>
		                      	...
		                      	<span class='col-sm-8 col-8 text-uppercase'>" . $cmrow['lname'] . ", " . $cmrow['fname'] . " " . middle_initial($cmrow['mname']) . "</span>
		                    </div>
						";
					}
				}
			...
			$output .= "
					<div class='row votelist'>
                      	<span class='col-sm-4 col-4 text-uppercase'><span class='pull-right'><b>" . $row['description'] . " :</b></span></span> 
                      	<span class='col-sm-8 col-8 text-uppercase'>" . $csrow['lname'] . ", " . $csrow['fname'] . " " . middle_initial($csrow['mname']) . "</span>
                    </div>
				";
			}
		}
