        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="">
                <a href="#mytitleq" data-toggle="modal">
                    ...
                    <span class="pcoded-mtext">Election Settings</span>
                </a>
            </li>
            <li class="">
                <a href="database.php">
                    <span class="pcoded-micon"><img src="../libraries/img/database.png"></span>
                    <span class="pcoded-mtext">Export/Import Database</span>
                </a>
            </li>
            <li class="">
                <a href="archives.php">
                    <span class="pcoded-micon"><img src="../libraries/img/file.png"></span>
