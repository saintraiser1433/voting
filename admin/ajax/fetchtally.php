                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            while ($rowt = $cquery->fetch_assoc()) {
                                ...
                                $roundt = round($finalt);
                                echo '
                                                                    <br><label> ' . ($rsst ? $rsst->num_rows : 0) . ' - Votes</label>
                                                                    <div class="progress">
                                                                        <div class="progress-bar progress-bar-striped progress-bar-primary" role="progressbar" style="width: ' . $roundt . '%" aria-valuenow="' . $roundt . '" aria-valuemin="0" aria-valuemax="' . ($rpq ? $rpq->num_rows : 0) . '"></div>
                                                                    </div><br>';
                            }
