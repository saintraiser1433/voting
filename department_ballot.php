...
// Resolve voter's department via course/strand
$deptRes = $conn->query("
...
$department_name = $deptRow ? $deptRow['department_name'] : '';
                        ...
                        <div class="page-wrapper">
                            <div class="page-body">
                                        ...
                                        <div class="card bg-c-green text-white">
                                            <div class="card-block">
                                                <div class="row text-center">
                                                    <div class="col">
                                                        <h5 class="m-b-5 text-uppercase text-center">
                                                            <b>
                                                                <img src="libraries/img/glanlogo.png"
                                                                     style="width:60px; height:60px;">
                                                                <?php echo $row['title']; ?> - Department (<?php echo $department_name; ?>)
                                                            </b>
                                                        </h5>
                                                        <span>
                                                            Note: Always make sure to click "Preview" Button before
                                                            submitting your votes! Thank you and god bless!
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <form method="POST" id="ballotForm" action="submit_department_ballot.php">
                                    ...
                                    $candidate = '';
                                    $sql = "SELECT * FROM position WHERE acad_id='$acad' AND election_type='department' ORDER BY priority ASC";
                                    $query = $conn->query($sql);
                                    while ($row = $query->fetch_assoc()) {
                                        $sqlCandidates = "
                                            SELECT *, candidate.img as im
                                            FROM candidate
                                            INNER JOIN voters ON candidate.stud_id = voters.stud_id
                                            WHERE candidate.acad_id = '$acad'
                                              AND candidate.pos_id = '" . $row['pos_id'] . "'
                                              AND candidate.election_type = 'department'
                                              AND candidate.department_id = '$department_id'
                                        ";
                                        ...
                                        while ($crow = $cquery->fetch_assoc()) {
                                            ...
                                            $input = ($row['max_vote'] > 1)
                                                ? '<div class="checkbox-fade fade-in-success mt-4" id="chck">
                                                        <label>
                                                ...
                                                : '<div class="form-radio m-b-30 mt-4">
                                            ...
                                            $candidate .= '
                                                <div class="row mt-2">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <img src="' . $image . '" style="width:120px; height:120px; border:2px solid steelblue; border-radius:10px;">
                                                        </li>
                                                    </ul>
                                                    <div class="text-center mt-3 pl-3">
                                                        <h3 class="text-uppercase font-weight-bold" id="myh3">'
                                                            . $crow['fname'] . ', ' . $crow['lname'] . ' ' . $crow['mname'][0] . '.
                                                        </h3>
                                                    </div>
                                                </div>';
                                        }
...
<script>
    $('#btn-submit').on('click', function (e) {
        ...
        swal({
            title: "Are you sure?",
            text: "Once you click 'FINISH', your department vote will be cast!",
            icon: "info",
            buttons: true,
        })
            .then((willSubmit) => {
